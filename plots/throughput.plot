...
#
#
# Plot throughput data for write requests.
# This assumes an input file named 'chum.out' in the current directory filled
# with chum's tabular output data on a five-second interval.
#
unset clip points
set clip one
unset clip two
...
unset ttics
set title "Throughput over Time (MB/s)" 
...
plot 'chum.out' u 1:($3/5) t 'chum tick data' w dots
#    EOF
