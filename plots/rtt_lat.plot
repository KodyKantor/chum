...
#
#
# Plot round-trip-time latency for write requests.
...
unset ttics
set title "RTT Latency over Time (write-only)" 
...
set ylabel "RTT Latency (milliseconds)" 
...
plot 'chum.out' u 1:($9/1000) t 'chum tick data' w dots
#    EOF
